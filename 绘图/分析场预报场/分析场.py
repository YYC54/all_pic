...
file_path = '/Users/yanyuchen/绘图/分析场预报场/分析场/2017062106_p.nc'
pressure = read_nc(file_path, 'p')

file_path = '/Users/yanyuchen/绘图/分析场预报场/分析场/2017062106_rh.nc'
rh = read_nc(file_path, 'rh')
#rh = np.where(rh == 9.96921E36, np.nan, rh)

file_path = "/Users/yanyuchen/绘图/分析场预报场/分析场/2017062106_geopt.nc"
...
ax.set_title('400 hPa analysis field')
ax.set_xlabel("lon")
ax.set_ylabel("lat")

plt.savefig('400 pha analysis field',dpi = 300)
plt.show()
