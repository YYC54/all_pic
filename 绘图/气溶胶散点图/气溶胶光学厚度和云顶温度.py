...
aod_folder = '/Users/yanyuchen/气溶胶散点图/Merry-2'  #你的merry-2文件夹路径
ctt_folder = '/Users/yanyuchen/气溶胶散点图/CTO'      #cto 文件夹路径
...
plt.title('Monthly Mean AOD and CTT Scatter Plot')
